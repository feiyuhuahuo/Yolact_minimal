...
yolact_base_config = Config({
    ...
    'momentum': 0.9,
    'decay': 5e-4,
    # the initial learning rate in the 'warm up' step, if > 0 then increase the lr linearly
    # from warmup_init to lr each iter for until iters
    'lr_warmup_init': 1e-4,
    'lr_warmup_until': 500,
    ...
    # Add a 1x1 convolution directly to P3 to predict semantic segmentations for each of the 80 classes.
    # This branch is only implemented during training and is just for multitask learning.
